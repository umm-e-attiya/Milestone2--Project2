...
const About = () =>{
    ...
    return(
            <div id="mainabout">
                ...
                <p id="a">Currently, I am expanding my skills in HTML, CSS, and JavaScript, and I am learning frameworks like Next.js and Tailwind CSS to create responsive, visually appealing websites. My hands-on experience also includes managing a balance between academic studies and an internship, where I am applying what I learn directly in real-world projects.</p>
